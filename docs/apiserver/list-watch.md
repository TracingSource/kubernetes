...
```
staging/src/k8s.io/apiserver/pkg/endpoints/handlers/watch.go -> WatchServer.ServeHTTP()
```
...
加上这几个响应头, 就能用 fluster 对象无限写回数据.

## lister watcher informer reflector

貌似 apiserver 没有用到 informer...
