...
// initializeModules 初始化一些无需 docker 运行就可以启动的模块,
// 如设置kubelet数据目录, 容器日志目录, 启动镜像管理器, oom监听器, 和资源监控器等.
//
// caller: 
// 	1. kl.Run()
//
// initializeModules will initialize internal modules 
// that do not require the container runtime to be up.
...
func (kl *Kubelet) initializeModules() error {
	...
	// serverCertificateManager 一般为 nil
	//
